...
class Geometry
{
	...
	public static double parallelogramArea (double bo, double h)
	{
		return bo * h;
	}
	
	public static double triangleArea (double bo, double h)
	{
		return bo * h/2;
	}
	
	public static double trapezoidArea (double bo, double bt, double h)
	{
		return ((bo + bt)/2) *h;
	}
	
	public static double hexagonArea (double bo, double bt, double h)
	{
		return (bo + bt) * h;
	}
